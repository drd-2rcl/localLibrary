...
function createGenreAuthors(cb) {
  async.parallel([
    function(callback) {
      authorCreate('Patrick',  'Rothfuss', '1973-06-6', false, callback);
    },
    function(callback) {
    ...
    function(callback) {
      authorCreate('Fantasy', callback);
    },
    function(callback) {
      authorCreate('Science Fiction', callback);
    },
    function(callback) {
      authorCreate('French Poetry', callback);
    },
  ],
  //optional callback
  cb);
...
function(err, results) {
  if(err) {
    ...
    console.log('BOOKInstance: '+bookinstances);
  }
    // All done, disconect from my_database
